//
// DeviceResourcesDX12.h - A wrapper for the Direct3D 11 device and swapchain
//
...
namespace DX
{
    ...
    public:
        ...
        DeviceResourcesDX11(DXGI_FORMAT backBufferFormat = DXGI_FORMAT_B8G8R8A8_UNORM,
                        DXGI_FORMAT depthBufferFormat = DXGI_FORMAT_D32_FLOAT,
                        UINT backBufferCount = 2,
                        D3D_FEATURE_LEVEL minFeatureLevel = D3D_FEATURE_LEVEL_10_0,
                        unsigned int flags = c_FlipPresent) noexcept;
        ~DeviceResourcesDX11() = default;

        DeviceResourcesDX11(DeviceResourcesDX11&&) = default;
        DeviceResourcesDX11& operator= (DeviceResourcesDX11&&) = default;

        DeviceResourcesDX11(DeviceResourcesDX11 const&) = delete;
        DeviceResourcesDX11& operator= (DeviceResourcesDX11 const&) = delete;
