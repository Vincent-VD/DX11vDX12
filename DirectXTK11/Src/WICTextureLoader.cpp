...
bool DirectX11::DX11::Internal::IsWIC2() noexcept
{
    return g_WIC2;
}

IWICImagingFactory* DirectX11::DX11::Internal::GetWIC() noexcept
{
...
using namespace DirectX11::DX11::Internal;
...
HRESULT DirectX11::CreateWICTextureFromMemory(
...
_Use_decl_annotations_
HRESULT DirectX11::CreateWICTextureFromMemoryEx(
    ID3D11Device* d3dDevice,
    const uint8_t* wicData,
    size_t wicDataSize,
    size_t maxsize,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HRESULT DirectX11::CreateWICTextureFromFile(
    ID3D11Device* d3dDevice,
...
_Use_decl_annotations_
HRESULT DirectX11::CreateWICTextureFromFileEx(
    ID3D11Device* d3dDevice,
    const wchar_t* fileName,
    size_t maxsize,
    D3D11_USAGE usage,
