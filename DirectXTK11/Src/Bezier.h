...
namespace Bezier
{
    ...
    template<>
    inline DirectX11::XMVECTOR CubicInterpolate(DirectX11::XMVECTOR const& p1, DirectX11::XMVECTOR const& p2, DirectX11::XMVECTOR const& p3, DirectX11::XMVECTOR const& p4, float t) noexcept
    {
    ...
    template<>
    inline DirectX11::XMVECTOR CubicTangent(DirectX11::XMVECTOR const& p1, DirectX11::XMVECTOR const& p2, DirectX11::XMVECTOR const& p3, DirectX11::XMVECTOR const& p4, float t) noexcept
    {
        using namespace DirectX11;
    ...
    void CreatePatchVertices(_In_reads_(16) const DirectX11::XMVECTOR patch[16], size_t tessellation, bool isMirrored, TOutputFunc outputVertex)
    {
        using namespace DirectX11;
