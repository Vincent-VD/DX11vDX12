...
#pragma pack(push,1)
    ...
    struct Material
    {
        DirectX11::XMFLOAT4   Ambient;
        DirectX11::XMFLOAT4   Diffuse;
        DirectX11::XMFLOAT4   Specular;
        float               SpecularPower;
        DirectX11::XMFLOAT4   Emissive;
        DirectX11::XMFLOAT4X4 UVTransform;
    };
    ...
    {
        int32_t ParentIndex;
        DirectX11::XMFLOAT4X4 InvBindPos;
        DirectX11::XMFLOAT4X4 BindPos;
        DirectX11::XMFLOAT4X4 LocalTransform;
    };
    ...
    struct Keyframe
    {
        uint32_t BoneIndex;
        float Time;
        DirectX11::XMFLOAT4X4 Transform;
    };
...
std::unique_ptr<Model> DirectX11::Model::CreateFromCMO(
    ID3D11Device* device,
