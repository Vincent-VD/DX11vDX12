//
// DeviceResourcesDX12.cpp - A wrapper for the Direct3D 12 device and swapchain
//
...
// Constructor for DeviceResourcesDX12.
DeviceResourcesDX12::DeviceResourcesDX12(
...
// Destructor for DeviceResourcesDX12.
DeviceResourcesDX12::~DeviceResourcesDX12()
{
...
void DeviceResourcesDX12::CreateDeviceResources()
{
#if defined(_DEBUG)
    ...
    m_commandQueue->SetName(L"DeviceResourcesDX12");
    ...
    m_rtvDescriptorHeap->SetName(L"DeviceResourcesDX12");
    ...
    if (m_depthBufferFormat != DXGI_FORMAT_UNKNOWN)
    {
        ...
        m_dsvDescriptorHeap->SetName(L"DeviceResourcesDX12");
    }
    ...
    m_commandList->SetName(L"DeviceResourcesDX12");
    ...
    m_fence->SetName(L"DeviceResourcesDX12");
...
void DeviceResourcesDX12::SetWindow(HWND window, int width, int height) noexcept
{
    m_window = window;
...
bool DeviceResourcesDX12::WindowSizeChanged(int width, int height)
{
    RECT newRc;
...
void DeviceResourcesDX12::Prepare(D3D12_RESOURCE_STATES beforeState, D3D12_RESOURCE_STATES afterState)
{
...
void DeviceResourcesDX12::Present(D3D12_RESOURCE_STATES beforeState)
{
...
void DeviceResourcesDX12::WaitForGpu() noexcept
{
...
void DeviceResourcesDX12::MoveToNextFrame()
{
...
void DeviceResourcesDX12::GetAdapter(IDXGIAdapter1** ppAdapter)
{
    *ppAdapter = nullptr;
...
void DeviceResourcesDX12::UpdateColorSpace()
{
    if (!m_dxgiFactory)
        return;
