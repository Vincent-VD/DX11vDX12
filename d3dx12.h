...
public: // Function declaration
    ...
    // InitializeDX11 data from the given device
...
inline HRESULT CD3DX12FeatureSupport::Init(ID3D12Device* pDevice)
{
    ...
    // InitializeDX11 static feature support data structures
    ...
    // InitializeDX11 per-node feature support data structures
    ...
    // InitializeDX11 features that requires highest version check
    ...
    // InitializeDX11 Feature Levels data
