//
// DeviceResourcesDX11.cpp - A wrapper for the Direct3D 11 device and swapchain
...
// Constructor for DeviceResourcesDX11.
DeviceResourcesDX11::DeviceResourcesDX11(
...
void DeviceResourcesDX11::CreateDeviceResources()
{
...
void DeviceResourcesDX11::SetWindow(HWND window, int width, int height) noexcept
{
    m_window = window;
...
bool DeviceResourcesDX11::WindowSizeChanged(int width, int height)
{
    RECT newRc;
...
void DeviceResourcesDX11::CreateFactory()
{
...
void DeviceResourcesDX11::GetHardwareAdapter(IDXGIAdapter1** ppAdapter)
{
    *ppAdapter = nullptr;
...
void DeviceResourcesDX11::UpdateColorSpace()
{
    if (!m_dxgiFactory)
        return;
