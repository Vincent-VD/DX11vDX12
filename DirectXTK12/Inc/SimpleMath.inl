...
inline Color::Color(const DirectX12::PackedVector::XMCOLOR& Packed) noexcept
{
    using namespace DirectX12;
    XMStoreFloat4(this, PackedVector::XMLoadColor(&Packed));
}

inline Color::Color(const DirectX12::PackedVector::XMUBYTEN4& Packed) noexcept
{
    using namespace DirectX12;
...
inline Color& Color::operator= (const DirectX12::PackedVector::XMCOLOR& Packed) noexcept
{
    using namespace DirectX12;
    XMStoreFloat4(this, PackedVector::XMLoadColor(&Packed));
    return *this;
...
inline Color& Color::operator= (const DirectX12::PackedVector::XMUBYTEN4& Packed) noexcept
{
    using namespace DirectX12;
    XMStoreFloat4(this, PackedVector::XMLoadUByteN4(&Packed));
    return *this;
...
inline DirectX12::PackedVector::XMCOLOR Color::BGRA() const noexcept
{
    using namespace DirectX12;
...
inline DirectX12::PackedVector::XMUBYTEN4 Color::RGBA() const noexcept
{
    using namespace DirectX12;
    const XMVECTOR clr = XMLoadFloat4(this);
...
{
    return DirectX12::TriangleTests::Intersects(position, direction, tri0, tri1, tri2, Dist);
}
